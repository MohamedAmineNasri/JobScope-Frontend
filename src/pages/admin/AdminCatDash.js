  ...
  const handleCloseDialog = () => {
    setIsDialogOpen(false);
            ...
            let data = [];
            // Create a state variable for grid data
            const [gridData, setGridData] = useState([]);
            // Update grid data state when jobType changes
            useEffect(() => {
                if (jobType) {
                setGridData(jobType);
                }
            ...
            const columns = [
                ...
                renderCell: (values) => (
                    ...
                    <Button
                        onClick={(e) => deleteJobCatById(e, values.row._id)}
                        variant="contained"
                        color="error"
                    >
                        Delete
                        ...
                        <div className="dashboard-table">
                            ...
                            <Box>
                                ...
                                <Box sx={{ height: 400, width: "100%" }}>
                                    ...
                                    rows={gridData} // Use the updated grid data state
                                    columns={columns}
                                    pageSize={5}
