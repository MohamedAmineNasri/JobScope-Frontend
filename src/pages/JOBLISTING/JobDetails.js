  ...
  return (
    <div className="details-container">
      ...
      <div className="details-desktop7">
        ...
        <img
          alt="Rectangle1621561"
          src="/external5/rectangle1621561-kxp-400h.png"
          className="details-rectangle162"
        />
        <div className="details-group367">
          <div className="details-group366">
            ...
            <div className="details-group365">
              <div className="details-group363">
                <div className="details-group364">
                  <span className="details-text073">
                    <span>Subscribe</span>
                  </span>
                </div>
              </div>
        ...
        <div className="details-group390">
          <div className="details-frame368">
            ...
            <span className="details-text077">
              <span>About</span>
            </span>
            <span className="details-text079">
              <span>Jobs</span>
            </span>
            <span className="details-text081">
              <span>Contact Us</span>
            </span>
            <span className="details-text083">
              <span>Terms</span>
            </span>
            <span className="details-text085">
              <span>Privacy Policy</span>
            </span>
          </div>
          <div className="details-group389">
            <img
              alt="Vector411561"
        ...
        <span className="details-text147">
          <span>Featured Job Circulars</span>
        </span>
        <div className="details-job-details">
          <div className="details-job-details1">
            {/* <img
              alt="Rectangle132291"
              src="/external5/rectangle132291-xw8fu-200h.png"
              className="details-rectangle13"
            /> */}
            {/* <span className="details-text149">
              <span>Post a job</span>
            </span> */}
            <img
              alt="Rectangle112291"
              src="/external5/rectangle112291-c6ld-200h.png"
              className="details-rectangle11"
            />
            <span className="details-text151">
              <span>
            ...
            <span className="details-text153">
              <span className="details-text154">
                <br></br>
                <br></br>
                <br></br>
                <span>{singleJob && singleJob.description}</span>
                <br></br>
                <span></span>
                <br></br>
                <span></span>
                <div className="details-job-details">
                  ...
                  <img
                    alt="Rectangle1592286"
                    src="/external/reasons_to_search_jobs_online.png"
                    className="desktop7-rectangle159"
                    style={{ top: "200px" }}
                  />
                  <div className="desktop7-group387" style={{ top: "750px" }}>
              ...
              {/* <span className="details-text170">
                <span>Laravel Developer Requirements:</span>
                <br></br>
                <span></span>
              </span> */}

              {/* <span className="details-text174">
                <span></span>
                <br></br>
                <span>
              ...
              {/* <span className="details-text198">
            ...
            <img
              alt="Rectangle122291"
              src="/external5/rectangle122291-txah-200h.png"
              className="details-rectangle12"
            />
            <span className="details-text222">
          ...
          <span className="details-text231">
            ...
            {/* <span className="details-text238">Experience Level:</span> */}
            {/* <span className="details-text239">
              <span
                dangerouslySetInnerHTML={{
                  __html: " ",
                }}
            ...
            {/* <span className="details-text240">
              <span>Mid level</span>
              <br></br>
              <span></span>
            </span> */}
            {/* <span className="details-text244">Experience Length:</span> */}
            <span className="details-text245">
              <span
                dangerouslySetInnerHTML={{
                  __html: " ",
                }}
            ...
            {/* <span className="details-text246">
              <span>2 years</span>
              <br></br>
              <span></span>
            </span> */}
            ...
            {/* <span className="details-text256">Application Deadline:</span> */}
            <span className="details-text257">
              <span
                dangerouslySetInnerHTML={{
                  __html: " ",
                }}
            ...
            {/* <span className="details-text258">
